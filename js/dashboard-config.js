/*
  ...
  - A Power BI secure embed URL that your users are authorized to open
*/

window.DASHBOARD_CONFIG = [
  { id: 1,  name: "Pasting Machine Dashboard",  description: "Production, quality, downtime and OEE monitoring for the pasting process.", icon: "PM", url: "" },
  { id: 2,  name: "Casting Machine Dashboard", description: "Casting output, defects, process performance and machine status.", icon: "CM", url: "" },
  { id: 3,  name: "Assembly Line Dashboard",   description: "Assembly line performance, productivity, quality and daily targets.", icon: "AL", url: "https://app.powerbi.com/view?r=eyJrIjoiZjFkZDFlNzctMjQ4ZS00NDA5LWJiYWEtNGU1YzhkZGVhNzM0IiwidCI6ImJkMGIxZmU0LTcwZmEtNGE5MS1iMDI4LWE2MDA1NGQ5MTYyNSIsImMiOjEwfQ%3D%3D"},
